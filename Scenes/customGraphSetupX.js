function CustomGraphSetupX() {
    ...
    this.enter = function() {
        ...
        text("X Axis",simWidth/2, simHeight/16 * 3);
        ...
        nextButton = new Button("NEXT", simWidth/2, simHeight/2+simHeight/8, simWidth/4-simWidth/8, 50, color(60, 0, 0), color(100, 20, 20), color(240, 240, 240), () => me.sceneManager.showScene(CustomGraphSetupY));
    ...
    this.draw = function () {
        ...
        if (this.dataColumnChosen != "")
            nextButton.handleAndDraw();
